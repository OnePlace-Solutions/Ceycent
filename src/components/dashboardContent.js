...
const Dashboard = () => {
  ...
  const fetchTotalSales = async () => {
    try {
      const response = await axios.get('https://ceycent-server.vercel.app/sale'); // Fetch all sales
  ...
  const fetchTotalCustomers = async () => {
    try {
      const response = await axios.get('https://ceycent-server.vercel.app/customer');
  ...
  const fetchTotalItems = async () => {
    try {
      const response = await axios.get('https://ceycent-server.vercel.app/inventory');
