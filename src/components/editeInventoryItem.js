...
const EditItemPage = () => {
    ...
    useEffect(() => {
        const fetchItem = async () => {
            try {
                const response = await axios.get(`https://ceycent-server.vercel.app/inventory/${id}`);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`https://ceycent-server.vercel.app/inventory/${id}`, item); // Update the item
