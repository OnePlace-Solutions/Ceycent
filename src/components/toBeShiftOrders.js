...
const OrdersPage = () => {
    ...
    const fetchOrders = async () => {
        try {
            const response = await axios.get('https://ceycent-server.vercel.app/sale');
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                try {
                    ...
                    await axios.put(`https://ceycent-server.vercel.app/sale/${order._id}`, {
                        trackingNumber,
                        saleStatus: 'Shiped'
                    });
    ...
    const printOrders = () => {
        ...
        printWindow.document.write(`
            ...
            .to-address, .from-address, .cod { text-align: left; font-size: 16px; }
            .from-address { text-align: left; }
            .to-address { font-weight: bold; } /* Removed text-align:right for .to-address */
            .cod { font-size: 18px; font-weight: bold; text-align: center; }
