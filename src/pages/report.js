...
const MonthlyReport = () => {
  ...
  const fetchData = async () => {
    try {
      // Fetch total sales
      const salesResponse = await axios.get("https://ceycent-server.vercel.app/report/sales");
      setSales(salesResponse.data);

      // Fetch total expenses
      const expensesResponse = await axios.get("https://ceycent-server.vercel.app/report/expenses");
      setExpenses(expensesResponse.data);

      // Fetch total profit
      const profitResponse = await axios.get("https://ceycent-server.vercel.app/report/profit");
